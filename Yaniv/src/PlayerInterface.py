...
class PlayerInterface:
    ...
    def create_widgets(self):
        ...
        self.labelScorePlayer3 = tk.Label(frameScorePlayer3, text="Score: 0", bg="white", font=("Arial", 8))
        ...
        self.labelScorePlayer4 = tk.Label(frameScorePlayer4, text="Score: 0", bg="white", font=("Arial", 8))
